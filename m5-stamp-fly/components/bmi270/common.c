...
/*
 * The legacy-driver I2C path (getI2cBus/putI2cBus/_i2cWrite/_i2cRead and
 * bmi2_i2c_read/bmi2_i2c_write) was removed: the BMI270 is on SPI, so it was
 * dead code, and merely linking the legacy driver/i2c.h API aborts the boot
 * now that Arduino Wire uses the new i2c_master driver.
 */
