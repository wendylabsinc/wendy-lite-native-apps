 ...
 *
 */
/* bmi2_i2c_read was removed: the BMI270 is on SPI and the legacy-driver I2C
 * implementation cannot be linked next to Arduino Wire (new i2c_master). */
 ...
 *
 */
/* bmi2_i2c_write: see bmi2_i2c_read note above. */
